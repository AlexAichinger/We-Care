...
def run_local(args):
    if args.command == 'all-local':
        ...
        detect_faces_from_uri(args.uri)
...
if __name__ == '__main__':
    ...
    detect_faces_from_uri_parser = subparsers.add_parser(
        'faces-uri', help=detect_faces_from_uri.__doc__)
    detect_faces_from_uri_parser.add_argument('uri')
